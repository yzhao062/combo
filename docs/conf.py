...
version_path = os.path.join(combo_dir, 'combo', 'version.py')
...
latex_documents = [
    (master_doc, 'combo.tex', 'combo Documentation',
     'Yue Zhao', 'manual'),
]
...
man_pages = [
    (master_doc, 'combo', 'combo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'combo', 'combo Documentation',
     author, 'combo', 'One line description of project.',
     'Miscellaneous'),
]
